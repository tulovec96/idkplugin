...
local function createGui()
	...
	main.Size = UDim2.new(0, 1200, 0, 800)
	main.Position = UDim2.new(0.5, -600, 0.5, -400)
	...
	shadow.Color = Color3.fromRGB(0, 150, 200)
	shadow.Thickness = 2
	shadow.Parent = main
	...
	subtitle.Text = "AI-powered code generation with action planning"
...
mainButton.Click:Connect(function()
	if STATE.isOpen and STATE.currentGui then
		...
		STATE.currentGui.generateBtn.MouseButton1Click:Connect(function()
			...
			if prompt == "" then
				STATE.currentGui.statusLabel.Text = "✗ Enter a request!"
				STATE.currentGui.statusLabel.TextColor3 = Color3.fromRGB(200, 100, 0)
				return
			end
			
			STATE.currentGui.statusLabel.Text = "⏳ Generating code..."
			...
			if success then
				...
				STATE.currentGui.statusLabel.Text = "✓ Code generated!"
		...
		-- Generate plan
		STATE.currentGui.planBtn.MouseButton1Click:Connect(function()
			local prompt = STATE.currentGui.promptInput.Text
			local model = STATE.currentGui.modelInput.Text
			
			if prompt == "" then
				STATE.currentGui.statusLabel.Text = "✗ Enter a request first!"
				STATE.currentGui.statusLabel.TextColor3 = Color3.fromRGB(200, 100, 0)
				return
			end
			
			STATE.currentGui.statusLabel.Text = "⏳ Creating action plan..."
			STATE.currentGui.statusLabel.TextColor3 = Color3.fromRGB(150, 150, 0)
			...
			if success then
				...
				STATE.currentGui.planOutput.Text = plan
				STATE.currentGui.statusLabel.Text = "✓ Plan generated!"
				STATE.currentGui.statusLabel.TextColor3 = Color3.fromRGB(0, 200, 0)
				log("Generated plan: " .. string.len(plan) .. " chars")
			else
				STATE.currentGui.statusLabel.Text = "✗ Error: " .. plan
				STATE.currentGui.statusLabel.TextColor3 = Color3.fromRGB(200, 0, 0)
			end
		end)
		...
		STATE.currentGui.executeBtn.MouseButton1Click:Connect(function()
			...
			STATE.currentGui.statusLabel.Text = "⏳ Executing..."
			STATE.currentGui.statusLabel.TextColor3 = Color3.fromRGB(150, 150, 0)
		...
		STATE.currentGui.copyBtn.MouseButton1Click:Connect(function()
			...
			STATE.currentGui.statusLabel.Text = "✓ Copy with Ctrl+C"
			STATE.currentGui.statusLabel.TextColor3 = Color3.fromRGB(0, 200, 0)
		end)
		...
		STATE.currentGui.clearBtn.MouseButton1Click:Connect(function()
			...
			STATE.currentGui.planOutput.Text = ""
			STATE.generatedCode = ""
			STATE.generatedPlan = ""
			STATE.currentGui.statusLabel.Text = "✓ Cleared"
			STATE.currentGui.statusLabel.TextColor3 = Color3.fromRGB(0, 200, 0)
		end)
